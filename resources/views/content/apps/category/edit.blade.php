      ...
      <div class="card-body">
        <ul class="nav nav-pills" role="tablist">
          <li class="nav-item">
            <a
                    ...
                    aria-selected="true"
            >
              <i data-feather="info"></i><span class="d-none d-sm-block">{{__('locale.Cateogry edit')}}</span>
            </a>
          </li>
        </ul>
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form class="needs-validation" action="{{route('category.update',['id'=>request()->id])}}"  method="POST"   novalidate>
            @csrf
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">{{__('locale.Cateogry edit')}}</h4>
                    </div>
                    <div class="card-body">

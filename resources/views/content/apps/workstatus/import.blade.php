            ...
            <div class="col-md-8 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">New Work Status</h4>
                    </div>
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" action="{{route('workstatus.load')}}" enctype="multipart/form-data" id="my_form">
                            @csrf
                            <div class="row">
                                <div class="col-12">
    ...
    <script>
        $("#my_form").submit(function(event){
            ...
            $.ajax({
                ...
                complete: function(){
                    hideLoading();
                    window.location.href = "{{ route('workstatus.index')}}";
                },
                success: function() {}

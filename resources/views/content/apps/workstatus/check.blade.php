...
@section('title', 'Prelievi Mancanti')
    ...
    <script>
        ...
        $(function () {
            ...
            var columnDefs = [
                ...
                {
                    headerName: 'material_description_2',
                    field: 'material_description_2',
                    editable: false,

                },
                {
                    headerName: 'requirement_quantity',
                ...
                },
                {
                    ...
                    field: 'quantity_2',
                    editable: params => {
                        if (params.data.requirement_quantity !== '0') {
                            return true;
                        }
                        return false;
                    },
            ...
            var gridOptions = {
                ...
                onCellValueChanged: function ($asd) {
                    $.ajax({
                        url: "{{route('workstatus.edit_check')}}",
                        type: "post",
            ...
            agGrid.simpleHttpRequest({
                url: '{{route('workstatus.list_check',['id'=>app('request')->id])}}',

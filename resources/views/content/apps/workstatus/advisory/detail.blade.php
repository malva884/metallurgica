                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1 ">
                            <div class="col-4">
                                <button class="btn btn-primary" onclick="showColumns(true)"><i data-feather='eye'></i>
                                </button>
                                <button class="btn btn-primary" onclick="showColumns(false)"><i
...
@section('page-script')
    ...
    <script>
        ...
        $(function () {
            ...
            var columnDefs = [
...

                {
                    ...
                    cellStyle: params => {
                        return {color: 'black', backgroundColor: 'lightseagreen'};
                    },
                },
                {
                    headerName: 'M.M.T.T',
                    field: 'macchine_manpower_cost_theoretic',
                    cellClass: 'stringType',
                    width: 90,
                    valueFormatter: params => {
                        if (params.value === '0.00') {
                    ...
                    cellStyle: params => {
                        return {color: 'black', backgroundColor: 'lightskyblue'};
                    },
                },
                {
                    headerName: 'Material',
                ...
                },
                {
                    ...
                    valueFormatter: params => {
                        ...
                        if (params.data.material_2 === '') {
                            return '';
                        }
                    },
                    cellStyle: params => {
                        if (params.data.quantity_2 === '0' && params.data.material_2 !== '') {
                ...
                },
                {
                    ...
                    valueFormatter: params => {
                        ...
                        if (params.value !== null && params.data.material_2 !== '') {
                ...
                {
                    headerName: 'Costo Reale',
                    field: 'material_real_cost',
                    width: 110,
                    valueFormatter: params => {
                ...
                {
                    headerName: 'Costo Teorico',
                    field: 'material_theoretic_cost',
                    width: 110,
                    valueFormatter: params => {
                        if (params.data.material_2 === '') {
                            return '';
            ...
            agGrid.simpleHttpRequest({
                url: '{{route('advisorys.list',['id'=> app('request')->id])}}',
        ...
        function Calcola(id) {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('advisorys.finalWork',['id'=>app('request')->id])}}',
                data: {
                    "_token": "{{ csrf_token() }}"
                },
                success: function (data) {
                    window.location = "/advisorys/index";
                },
            });
        }

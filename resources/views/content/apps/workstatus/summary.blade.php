                            ...
                            <div class="col-11">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Totali Stato Lavori</h4>
                                    </div>
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr class="table-secondary">
                                                <td>- {{number_format($head->total_raw_material - $head->total_final_mp,2)}} €</td>
                                                <td>
                                                    - {{number_format($head->raw_material_machine_manpower_cost - $head->total_final,2)}} €</td>
                                                <td>Variazione</td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td></td>
                                                <td>Ordini di sperimentazione</td>
                                            </tr>
                                            <tr class="table-warning">
                                                <td>€ {{number_format($head->total_raw_material,2)}}</td>
                                                <td>€ {{number_format($head->raw_material_machine_manpower_cost,2)}}</td>
                                                <td>Valore precedente</td>
                                            </tr>
                                            <tr class="table-success">
                                                <td>€ {{number_format($head->total_final_mp,2)}}</td>
                                                <td>€ {{number_format($head->total_final,2)}}</td>
                                                <td>Valore finale</td>
                                            </tr>
                                            </tbody>
                                        </table>
    ...
    <script>
        ...
        $(function () {
            ...
            var columnDefs = [
                ...
                {
                    headerName: 'Corr. costo tot. cons.',
                    field: 'total_consuntivo',
                    editable: false,
                    valueFormatter: params => {
                        if (params.value === '0.00') {
                            return '€ 0.00'
            ...
            agGrid.simpleHttpRequest({
                url: '{{route('workstatus.list_summary',['id'=> app('request')->id])}}',

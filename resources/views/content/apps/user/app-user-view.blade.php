                ...
                <div class="d-flex justify-content-start">
                  ...
                  <div class="d-flex flex-column ml-1">
                    ...
                    <div class="d-flex flex-wrap">
                      <a href="{{url('user/edit/'.$user->id)}}" class="btn btn-primary">{{__('locale.Edit')}}</a>
              ...
              <div class="user-info-wrapper">
                ...
                <div class="d-flex flex-wrap my-50">
                  <div class="user-info-title">
                    ...
                    <span class="card-text user-info-title font-weight-bold mb-0">{{__('locale.Vat')}}</span>
                  </div>
                  <p class="card-text mb-0">{{$user->vat}}</p>
                </div>
                <div class="d-flex flex-wrap my-50">
                  <div class="user-info-title">
                    <i data-feather="dollar-sign" class="mr-1"></i>
                  ...
                  <p class="card-text mb-0">{{$user->tax_code}}</p>
                </div>
              </div>
            </div>
          </div>

                ...
                <div class="mt-2">
                    ...
                    <select class="form-control mb-1" id="category">
                        ...
                        @foreach($categories as $category)
                            <option value="{{$category->id}}" {{($category->id == $document->category ? 'selected':'')}}>{{$category->category}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="colFormLabel" class="col-sm-6 col-form-label col-form-label">Document
                                number</label>
                            <div class="col-sm-6">
                                <div class="input-group disabled-touchspin">
                                    <input type="number" class="touchspin" id="page_n" value="{{$page_n}}" disabled/>
                                </div>
                            </div>
                        </div>

                        <button type="button" class="btn btn-outline-primary btn-block" onclick="saveDocument()">Save
                        </button>
                        <button type="button" class="btn btn-relief-success btn-block mb-75" id="btn-add-new">Add Page
                        </button>
                    </div>
                </div>

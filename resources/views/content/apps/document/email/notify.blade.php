                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:bold;line-height:1;text-align:left;color:#555;">
                                        Ciao <span
                                                style="font-weight: 700; font-size: 15px; margin-top: 0; --text-opacity: 1; color: #ff5850;">{{$name}}!</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center"
                                    ...
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                        @if(empty($final))
                                            nuova Specifica Tecnica creata, è in attesa della tua approvazione.
                                        @else
                                            una specifica è stata approvata!
                                        @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:10px;line-height:22px;text-align:center;color:#555;">
                                        Si prega di non rispondere direttamente a questa email. By <a
                                                href="{{env('APP_URL')}}"

    ...
    <div class="card-body">
      <ul class="nav nav-pills" role="tablist">
        <li class="nav-item">
          <a
            ...
            aria-selected="true"
          >
            <i data-feather="info"></i><span class="d-none d-sm-block">{{__('locale.Info collection')}}</span>
          </a>
        </li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
          ...
          <form class="needs-validation" action="{{route('collection.update',['id'=>request()->id])}}"  method="POST"   novalidate>
            @csrf

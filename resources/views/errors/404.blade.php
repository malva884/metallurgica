...
<div class="misc-wrapper">
  <a class="brand-logo" href="#">
    ...
    <h2 class="brand-text text-primary ms-1">Metallutgica Bresciana</h2>
  </a>
  <div class="misc-inner p-2 p-sm-3">
      <div class="w-100 text-center">
          <h2 class="mb-1">Page Not Found 🕵🏻‍♀️</h2>
          <p class="mb-2">Oops! 😖 Quello che stai cercando non esiste o non è più disponibile.</p>
          <a class="btn btn-primary mb-2 btn-sm-block" href="{{url('/')}}">Torna alla Dashboard</a>

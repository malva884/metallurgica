...
return [
  'custom' => [
    ...
    'navbarColor' => 'bg-info', // options[String]: bg-primary, bg-info, bg-warning, bg-success, bg-danger, bg-dark (default: '' for #fff)
    ...
    'defaultLanguage' => 'it',    //en(default)/de/pt/fr here are four optional language provided in theme
